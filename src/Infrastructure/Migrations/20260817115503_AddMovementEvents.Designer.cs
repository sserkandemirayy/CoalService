...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260817115503_AddMovementEvents")]
    partial class AddMovementEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AnchorMapPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FloorMapId", "AnchorId")
                        .IsUnique()
                        .HasFilter("\"DeletedAt\" IS NULL");

                    b.ToTable("AnchorMapPositions");
                });
            ...
            modelBuilder.Entity("Domain.Entities.CompanyUserCounter", b =>
                {
                    b.Property<Guid>("CompanyId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CompanyUserCounters", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.CurrentLocation", b =>
                {
                    ...
                    b.Property<Guid?>("FloorMapZoneId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Equipment", b =>
                {
                    ...
                    b.HasIndex("FloorMapId", "IsActive");
            ...
            modelBuilder.Entity("Domain.Entities.EquipmentCategory", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "ShowOnMap");

                    b.ToTable("EquipmentCategories");
                });

            modelBuilder.Entity("Domain.Entities.EquipmentInspection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EquipmentId", "InspectedAt");

                    b.ToTable("EquipmentInspections");
                });

            modelBuilder.Entity("Domain.Entities.FloorMap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.FloorMapCalibration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("MapOriginX")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<decimal>("MapOriginY")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<decimal>("MapOriginZ")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");
                    ...
                    b.Property<decimal>("SourceOriginX")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<decimal>("SourceOriginY")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<decimal>("SourceOriginZ")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");
                    ...
                    b.HasIndex("FloorMapId", "IsDefault");

                    b.ToTable("FloorMapCalibrations");
                });

            modelBuilder.Entity("Domain.Entities.FloorMapFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FloorMapId", "FileType", "Version");

                    b.ToTable("FloorMapFiles");
                });

            modelBuilder.Entity("Domain.Entities.FloorMapZone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.MovementEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RecordReason")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("BranchId", "EventTimestamp");

                    b.HasIndex("CompanyId", "EventTimestamp");

                    b.HasIndex("FloorMapId", "EventTimestamp");

                    b.HasIndex("FloorMapZoneId", "EventTimestamp");

                    b.HasIndex("TagId", "EventTimestamp");

                    b.HasIndex("UserId", "EventTimestamp");

                    b.ToTable("MovementEvents", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.AnchorMapPosition", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.FloorMap", "FloorMap")
                        .WithMany("AnchorPositions")
            ...
            modelBuilder.Entity("Domain.Entities.CompanyUserCounter", b =>
                {
                    b.HasOne("Domain.Entities.Company", "Company")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.CompanyUserCounter", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.CurrentLocation", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.FloorMapZone", "FloorMapZone")
                        .WithMany()
                        .HasForeignKey("FloorMapZoneId")
                        .OnDelete(DeleteBehavior.SetNull);
