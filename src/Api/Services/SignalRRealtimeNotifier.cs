...
public sealed class SignalRRealtimeNotifier : IRealtimeNotifier
{
    ...
    public async Task BatteryUpdatedAsync(
    ...
    public async Task AlarmRaisedAsync(
        ...
        CancellationToken ct = default)
    {
        ...
        {
            await _hub.Clients
                .Group($"tag:{payload.PeerTagId.Value}")
                .SendAsync("AlarmRaised", payload, ct);
        }
        ...
        {
            await _hub.Clients
                .Group($"anchor:{payload.AnchorId.Value}")
                .SendAsync("AlarmRaised", payload, ct);
        }
    }

    public async Task AnchorStatusChangedAsync(
    ...
    public async Task TagStatusChangedAsync(
